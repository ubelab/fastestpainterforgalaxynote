...
public class AnimationFactory {
	...
	static Animation jhonnyFaceAnimation;
...
*/
	...
	public static Animation getJhonnyFaceAnimation(Context context) {
		if(jhonnyFaceAnimation == null) {
			jhonnyFaceAnimation = AnimationUtils.loadAnimation(context, R.anim.jhonnyfaceanimation);
		}
		return jhonnyFaceAnimation;	
	}
