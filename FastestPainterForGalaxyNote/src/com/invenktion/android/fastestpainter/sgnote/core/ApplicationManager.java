...
public class ApplicationManager {
	...
	public static final double DISTURB_FREQUENCE = 10;//10
	...
	/*
	public static boolean JVM_1_6_PLUS = true;
	static {
		//Controllo se siamo in esecuzione su una VM 1.6+
		//altrimenti l'SDK crasha sulla LinkedList.push()
		Method[] methods = LinkedList.class.getMethods();
		boolean trovato = false;
		for(int i=0; i<methods.length; i++) {
			if(methods[i].getName().equalsIgnoreCase("push")) {
				trovato = true;
			}
		}
		if(trovato) {
