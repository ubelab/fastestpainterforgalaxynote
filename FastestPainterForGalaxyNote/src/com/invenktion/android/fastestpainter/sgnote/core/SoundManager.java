...
public class SoundManager {
	...
	private static void checkDeviceSoundState(Context context) {
	...
	*/
	...
	public static void playBackgroundMusic(Context context) {
		try {
			//Se l'utente ha messo la vibrazione o bloccato il suono a runtime spengo
			/*bug
			if(SoundManager.SOUND_ON) {
				checkDeviceSoundState(context);
			}
	...
	public static void initVolume(Context context) {
		...
		//FIX SAMSUNG REJECTION about sound
        int myVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
